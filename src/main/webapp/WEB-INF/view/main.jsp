  ...
  <div class="w3-row">
    ...
    <div class="w3-col m7">
      ...
      <div class="w3-container w3-card w3-white w3-round w3-margin"><br>
		    	...
		    	<img src="${pageContext.request.contextPath}/profileSave/${song.profilename}" alt="" class="w3-left w3-circle w3-margin-right" style="width:80px">
		    	</c:if>
		    	<c:if test="${song.profilename==null}">
		    	<img src="${pageContext.request.contextPath}/img/allears.jpg" alt="" class="w3-left w3-circle w3-margin-right" style="width:80px">
		    	</c:if>
