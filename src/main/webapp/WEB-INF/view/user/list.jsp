...
<div class="w3-container w3-display-topmiddle" style="width:60%; margin-top:15%;">	
  ...
  <table class="w3-table  w3-white w3-padding-large w3-bordered w3-hoverable">
    <thead>
      <tr class="w3-light-grey">
        ...
        <th align="center" width="150">포지션</th>
        <th align="center" width="250">가입일</th>
      </tr>
    </thead>
   <c:forEach var="user" items="${userList}">
    <tr>
      ...
      <td width="100">
      <a href="content?num=${user.num}&pageNum=${currentPage}&number=${number+1}">
      ${user.userid}</a></td>
